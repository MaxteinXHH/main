 ...
 */
var player;
function setPlayer(file, thumb, width, height, auto, play, name, playerPath,crossVideo) {
    if (!window.applicationCache && typeof(Worker) == "undefined") {
    	...
    	var _url = file;
    	if(crossVideo && crossVideo.filePath){
    		_url = crossVideo.filePath;
    	}
    	var content = '<video src="'+_url+'" poster="'+(thumb?thumb:(playerPath+'img/images/preview.jpg'))+'" preload controls="controls" width="'+width+'" height="'+height+'" ><p>Your user agent does not support the HTML5 Video element.</p></video>'
        $("#"+play).html(content);
    ...
    $.fn.sudyPlayer = function(option) {
        ...
        return this.each(function() {
            ...
            if (len > 0) {
                ...
                setPlayer(o.JSON[0].video, o.JSON[0].thumb, o.width, o.height, o.isAuto, playID, playerName, o.playerPath,o.JSON[0].crossVideo);
                    
                function playIndex(index) {
                    setPlayer(o.JSON[index].video, o.JSON[index].thumb, o.width, o.height, o.isAuto, playID, playerName, o.playerPath,o.JSON[0].crossVideo);
